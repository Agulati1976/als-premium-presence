...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Real Estate Services India, BPO Services India, Call Centre Services, Data Entry Services, Software Development Company, Digital Marketing Agency, IT Services Company, Business Process Outsourcing" },
      { name: "author", content: "Asset Light Solutions International" },
